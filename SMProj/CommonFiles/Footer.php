       ...
       <script src="../SiteResources/Scripts/jquery-2.2.4.min.js" type="text/javascript"></script>
       <script src="../SiteResources/Contents/js/bootstrap.min.js" type="text/javascript"></script>
</body>
</html>